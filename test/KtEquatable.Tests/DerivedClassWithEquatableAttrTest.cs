...
{
    [TestClass]
    public partial class DerivedClassWithEquatableAttrTest
    {
        [Equatable]
        public partial class Person
        {
            public string? Name { get; set; }
            [FloatingPointEquality(Precision = 2)]
        ...
        public class EqualsTests : EqualityTestWithOperatorBase
        {
            ...
            public override object Data1() => new Employee() { Name = "Juan", Age = 20.001, Salary = 60000 };

            public override object Data2() => new Employee() { Name = "Juan", Age = 20.002, Salary = 60000 };
        ...
        [TestClass]
        public class NotEqualsTests : EqualityTestWithOperatorBase
        {

...
#nullable enable
    ...
    public partial class MixedTests
    {
        ...
        [Equatable]
        public partial class Employer : ICompanyEntity
        {
        ...
        [Equatable]
        public partial struct EmployeeInfo : ICompanyEntity
        {
            public string? Name { get; set; }
            ...
            [ReferenceEquality]
            public Employer? Superior { get; set; }

            [ReferenceEquality]
            public string? SocialSecurity { get; set; }
        }

        private static readonly Employer Boss1 = new() { Name = "Bob", Id = 1 };
        private static readonly Employer Boss2 = new() { Name = "Bob", Id = 2 };
        ...
        public class TestIgnoreEquals : EqualityTestWithOperatorBase
        {
            ...
            public override bool EqualsOperator(object value1, object value2) => (Employer)value1 == (Employer)value2;
            public override bool NotEqualsOperator(object value1, object value2) => (Employer)value1 != (Employer)value2;
        }

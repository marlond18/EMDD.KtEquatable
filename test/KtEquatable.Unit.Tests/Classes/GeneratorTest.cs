...
namespace KtEquatable.Unit.Tests.Classes
{
    ...
    public class GeneratorTest
    {
        ...
        [DataTestMethod]
        [BasicDataSource(DataTypeGroup.NonClass, true, objName,propName, typeof(SourceClass))]
        ...
        [DataTestMethod]
        [BasicDataSource(DataTypeGroup.NonClass, false, objName,propName, typeof(SourceClass))]
        ...
        [DataTestMethod]
        [BasicDataSource(DataTypeGroup.Class, true, objName,propName, typeof(SourceClass))]
        ...
        [DataTestMethod]
        [BasicDataSource(DataTypeGroup.Class, false, objName,propName, typeof(SourceClass))]
        ...
        [DataTestMethod]
        [BasicDataSource(DataTypeGroup.Dictionary, true, objName,propName, typeof(SourceClass))]
        ...
        [DataTestMethod]
        [BasicDataSource(DataTypeGroup.Dictionary, false, objName,propName, typeof(SourceClass))]
        ...
        [DataTestMethod]
        [BasicDataSource(DataTypeGroup.Enumerable, true, objName, propName, typeof(SourceClass))]
        ...
        [DataTestMethod]
        [BasicDataSource(DataTypeGroup.Enumerable, false, objName, propName, typeof(SourceClass))]

...
namespace KtEquatable.Unit.Tests.Classes
{
    ...
    public class FloatingPointAttributeTests
    {
        ...
        [DataTestMethod]
        [FloatDataSource(-1, true, objName, propName, true,typeof(SourceClass))]
        ...
        [DataTestMethod]
        [FloatDataSource(-1, false, objName, propName, true, typeof(SourceClass))]
        ...
        [DataTestMethod]
        [FloatDataSource(-1, true, objName, propName, false, typeof(SourceClass))]
        ...
        [DataTestMethod]
        [FloatDataSource(-1, false, objName, propName, false, typeof(SourceClass))]
        ...
        [DataTestMethod]
        [FloatDataSource(10, true, objName, propName, true, typeof(SourceClass))]
        ...
        [DataTestMethod]
        [FloatDataSource(10, false, objName, propName, true, typeof(SourceClass))]
